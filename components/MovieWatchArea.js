            ...
            <div className="w-full">
                {currentEpisode?.link_m3u8 ? (
                    ...
                    <iframe
                        ...
                        className="relative w-full aspect-video bg-black rounded-lg overflow-hidden border border-white/10 shadow-[0_0_30px_rgba(0,255,65,0.2)]"
                        allowFullScreen
                    ...
                    <div className="flex items-center gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
                        ...
                        {episodes.map((server, index) => (
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all whitespace-nowrap ${selectedServerIndex === index
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                        {chunkList.map((chunk) => (
                            <button
                                ...
                                className={`px-3 py-1 rounded text-xs font-medium border transition-all ${currentChunk === chunk.index
